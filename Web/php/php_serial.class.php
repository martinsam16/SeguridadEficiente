<?php
 ...
 class phpSerial
 {
      ...
      function phpSerial ()
      {
           ...
           if (substr($sysname, 0, 5) === "Linux")
           {
                ...
                {
                     trigger_error("No está disponible, no puede correr.", E_USER_ERROR);
                }
           }
 ...
 //               }
           ...
           {
                trigger_error("El sistema operativo host no es ni osx, linux ni windows, no se puede ejecutar.", E_USER_ERROR);
                exit();
           }
      }
      ...
      function deviceSet ($device)
      {
           if ($this->_dState !== SERIAL_DEVICE_OPENED)
           {
                ...
                trigger_error("Puerto serie especificado no es válido", E_USER_WARNING);
                return false;
           }
           else
           {
                trigger_error("Debe cerrar su dispositivo antes para configurar otro", E_USER_WARNING);
                return false;
           }
      }
      ...
      function deviceOpen ($mode = "r+b")
      {
           if ($this->_dState === SERIAL_DEVICE_OPENED)
           {
                trigger_error("El dispositivo ya está abierto", E_USER_NOTICE);
                return true;
           }

           if ($this->_dState === SERIAL_DEVICE_NOTSET)
           {
                trigger_error("El dispositivo se debe configurar antes para abrir", E_USER_WARNING);
                return false;
           }
           ...
           $this->_dHandle = null;
           trigger_error("No se puede abrir el dispositivo", E_USER_WARNING);
           return false;
      }
      ...
      function deviceClose ()
      {
           ...
           trigger_error("No se puede cerrar el dispositivo", E_USER_ERROR);
           return false;
      }
      ...
      function _ckOpened()
      {
           if ($this->_dState !== SERIAL_DEVICE_OPENED)
           {
                trigger_error("El dispositivo debe ser abierto", E_USER_WARNING);
                return false;
           }
