...
CREATE TABLE IF NOT EXISTS `PROYECTO`.`Usuario` (
  ...
  `NomUser` VARCHAR(45) NULL, /*nombre del usuario que es gravado o tomado foto*/
  `ApellUser` VARCHAR(45) NULL,/*Apellido del usuario que es gravado o tomado foto*/
  `DNIUser` VARCHAR(8) NULL,/* DNI  del usuario que es gravado o tomado foto*/
